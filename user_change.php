        ...
        <div class="container">
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                ...
                <ul class="list-unstyled ml-4">
                    ...
                    <li><p class="font-weight-bold font-italic text-center d-block"><?php echo"$username"; ?></p></li>
            ...
            <div class="row">
                ...
                <div class="col-5">
                    <div class="form-group">
                        ...
                        <button type="button" class="btn btn-success mt-2">Saglabāt</button></p>
                    </div>
                    <div class="form-group">
                ...
                <div class="col-4">
                    <form>
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="parole" aria-describedby="vecaParole">
                        </div>
                        <div class="form-group">
                          <label for="exampleInputEmail1">Jaunā parole</label>
                          <input type="text" class="form-control" id="parole" aria-describedby="jaunaParole">
                        </div>
                        <div class="form-group">
